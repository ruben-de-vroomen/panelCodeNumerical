...
md"""
We want something to compare our testing methods to, so we will generate a generic wigley hull in order to have a control case, with no changes to the method.
"""
...
begin
	...
	md"""
	This function is just the one taken from wigley.jl
	"""
end
...
# ╔═╡ f1803165-821b-4e98-a987-9a13dfd171ea
Plots.scatter3d(centers(panels)...,marker_z=panels.dA/h^2,label=nothing)
...
# ╔═╡ 30c04bb2-12d9-42ac-bc02-e99b0d2e4edc
md"""
## Adapt wigley hull
"""
...
begin
	array = [0 2 3 4 7 3;4 5 6 7 8 9; 3 8 9 0 9 8; 7 6 5 4 2 3]
	test = findfirst(==(4), array[:][2])
	
end; display(test), display(array), display(array[4])
